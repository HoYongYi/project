            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="doctorVideo.jsp">Online Consultation</a></li>
...
<form method="get" action="/record">
    <div class="form-group">
        ...
        <input name="patientId" type="text" class="form-control" id="patientId" aria-describedby="patientId" placeholder=<%=request.getAttribute("patientId")%>>
    </div>
    <div class="form-group">
    ...
    <div class="input-group date" id="datepicker" data-provide="datepicker">
        <input name="date" type="text" class="form-control" placeholder=<%=request.getAttribute("date")%>><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
    </div>
    <div class="form-group">
